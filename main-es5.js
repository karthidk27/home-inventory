...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _inventory_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var routes = [{
      ...
      path: '**',
      component: _inventory_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_7__["NotFoundComponent"],
      canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _inventory_item_location_inventory_item_location_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _chart_representation_chart_representation_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./chart-representation/chart-representation.component */
    "./src/app/chart-representation/chart-representation.component.ts");
    /* harmony import */


    var _popover_forms_popover_forms_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./popover-forms/popover-forms.component */
    "./src/app/popover-forms/popover-forms.component.ts");
    /* harmony import */


    var _inventory_create_new_create_new_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./inventory/create-new/create-new.component */
    "./src/app/inventory/create-new/create-new.component.ts");
    /* harmony import */
    ...
    var _category_category_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./category/category.component */
    "./src/app/category/category.component.ts");
    /* harmony import */


    var _inventory_inventory_item_inventory_item_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./inventory/inventory-item/inventory-item.component */
    "./src/app/inventory/inventory-item/inventory-item.component.ts");
    /* harmony import */


    var _inventory_inventory_edit_inventory_edit_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./inventory/inventory-edit/inventory-edit.component */
    "./src/app/inventory/inventory-edit/inventory-edit.component.ts");
    /* harmony import */


    var _display_ellipsis_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./display-ellipsis.pipe */
    "./src/app/display-ellipsis.pipe.ts");
    /* harmony import */


    var _inventory_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./inventory/not-found/not-found.component */
    "./src/app/inventory/not-found/not-found.component.ts");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_3__["ChartsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_5__["HeaderComponent"], _layout_layout_component__WEBPACK_IMPORTED_MODULE_6__["LayoutComponent"], _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_7__["InventoryComponent"], _inventory_item_location_inventory_item_location_component__WEBPACK_IMPORTED_MODULE_8__["InventoryItemLocationComponent"], _chart_representation_chart_representation_component__WEBPACK_IMPORTED_MODULE_9__["ChartRepresentationComponent"], _popover_forms_popover_forms_component__WEBPACK_IMPORTED_MODULE_10__["PopoverFormsComponent"], _inventory_create_new_create_new_component__WEBPACK_IMPORTED_MODULE_11__["CreateNewComponent"], _category_category_component__WEBPACK_IMPORTED_MODULE_13__["CategoryComponent"], _inventory_inventory_item_inventory_item_component__WEBPACK_IMPORTED_MODULE_14__["InventoryItemComponent"], _inventory_inventory_edit_inventory_edit_component__WEBPACK_IMPORTED_MODULE_15__["InventoryEditComponent"], _display_ellipsis_pipe__WEBPACK_IMPORTED_MODULE_16__["DisplayEllipsisPipe"], _inventory_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_17__["NotFoundComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_18__["LoginComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_3__["ChartsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"]]
      });
    })();
    /*@__PURE__*/
      ...
      _createClass(CategoryComponent, [{
        ...
        value: function onAddCategory(form) {
          ...
          categoryArr.forEach(function (arrayElement) {
            ...
            _this2.allService.addCategory(newCategory);
          });
        }
      }]);
      ...
      _createClass(ChartRepresentationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.allServices.electronicsFilteredArray$.subscribe(function (inventory) {
            _this3.barChartData[0].data[0] = inventory.length;

            _this3.updateChart();

            _this3.calculateTotalInventory();
          });
          this.allServices.stationeryFilteredArray$.subscribe(function (inventory) {
            _this3.barChartData[0].data[1] = inventory.length;
          ...
          this.allServices.documentsFilteredArray$.subscribe(function (inventory) {
            _this3.barChartData[0].data[2] = inventory.length;
          ...
          this.allServices.booksFilteredArray$.subscribe(function (inventory) {
            _this3.barChartData[0].data[3] = inventory.length;
          ...
          this.allServices.othersFilteredArray$.subscribe(function (inventory) {
            _this3.barChartData[0].data[4] = inventory.length;
          ...
          this.allServices.unReturnedInventory.subscribe(function (count) {
            _this3.unRetunedInventories = count;
          });
      ...
      _createClass(HeaderComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.allServices.resetTextbox.subscribe(function (value) {
            _this4.searchBox.nativeElement.value = value;
          });
        }
      }, {
        ...
        value: function onSearch() {
          ...
          var filteredInventories = originalInventories.filter(function (inventory) {
            return inventory.itemName.toLowerCase().includes(_this5.searchText.toLowerCase());
          });
      ...
      _createClass(InventoryItemLocationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.allServices.selectedInventory$.subscribe(function (details) {
            _this6.itemName = details.itemName;
            _this6.roomName = details.roomNames;
            _this6.location = details.location;
            _this6.addInfo = details.addInfo;
          });
        }
      }]);
        ...
        value: function onLogin(form) {
          ...
          if (this.authService.login(user, password)) {
            ...
            setTimeout(function () {
              ...
              _this9.router.navigate(['/inventory']);
            }, 2000);
          } else {
